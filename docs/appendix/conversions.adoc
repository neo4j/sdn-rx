...
To make SDN/RX aware of your converter, it has to get registered in the `Neo4jConversions`.
This is done in the constructor of the class and requires to explicitly define a `@Bean` creation method in your application configuration.
...
If you need multiple converters in your application, you can add as much as you need in the `Neo4jConversions` constructor.
